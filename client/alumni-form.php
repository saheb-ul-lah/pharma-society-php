        ...
        <ul class="flex flex-col lg:flex-row lg:ml-auto space-x-4 items-center">
          ...
          <li class="relative group">
            ...
            <ul class="absolute hidden group-hover:block bg-navy mt-1 rounded-md shadow-lg">
              <li><a style="text-wrap: nowrap;" href="./alumni-form.html"
                  ...
                  Form</a></li>
              <li><a style="text-wrap: nowrap;" href="./student-form.html"
          ...
          <li class="ml-auto">
            <a href="./profile.html" class="flex items-center">
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJ-l3onxJrLVYB8Ak7aKCYcOznSKyaPz1P8Q&s"
                alt="Profile Image"
                class="w-10 h-10 rounded-full border-2 border-white hover:border-yellow-300 transition duration-300 ease-in-out">
            </a>
          </li>
        </ul>
