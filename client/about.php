        ...
        <ul class="list-none space-y-4">
          <li class="flex items-start">
            ...
            <span class="text-gray-700"
              >To enable the learner to develop sound theoretical knowledge and
          ...
          <li class="flex items-start">
            ...
            <span class="text-gray-700"
              >To train the learners with equipment and infrastructure to
          ...
          <li class="flex items-start">
            ...
            <span class="text-gray-700"
              >To enable the learners to undergo thorough internships that
          ...
          <li class="flex items-start">
            ...
            <span class="text-gray-700"
              >To enable the learners to implement ethical behaviors in their
          ...
          <li class="flex items-start">
            ...
            <span class="text-gray-700"
              >To enable the learners to receive guidance from a diverse field
      ...
      >
        ...
        >
          ...
          <div class="flex space-x-4 text-2xl text-gray-700">
            <a href="https://www.facebook.com/ducsjmc/" target="_blank"
              ><i class="fab fa-facebook"></i
            ></a>
            <a href="https://twitter.com/DUCSJMC" target="_blank"
              ><i class="fab fa-twitter"></i
            ></a>
            <a href="https://maps.app.goo.gl/hVm5jknh8hpqxqP88" target="_blank"
              ><i class="fab fa-google"></i
            ></a>
            <a href="https://www.instagram.com/dumasscomm/" target="_blank"
            ...
            <div class="w-full lg:w-1/4 px-4">
              ...
              <p>
                ...
                ><a
                  ...
                  target="_blank"
                  class="text-gray-700 font-semibold hover:underline"
                  >Pharmaceutical Society, Dibrugarh University, Dibrugarh,
                  Assam 786004</a
                >
              </p>
              <p>
