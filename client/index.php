    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          <li class="nav-item"><a class="nav-link" href="./index.html" onclick="setActiveLink(this)">Home</a></li>
          <li class="nav-item"><a class="nav-link" href="./alumni.html" onclick="setActiveLink(this)">Alumni</a></li>
          <li class="nav-item"><a class="nav-link" href="./students.html" onclick="setActiveLink(this)">Students</a>
          </li>
          <li class="nav-item"><a class="nav-link" href="./about.html" onclick="setActiveLink(this)">About</a></li>
          <li class="nav-item"><a class="nav-link" href="./news-events.html" onclick="setActiveLink(this)">News &
              events</a>
          </li>
  ...
  <section class="container mt-5 mb-5">
    <div class="row">
      <div class="col-md-6 mt-5">
        <h2 style="font-family: Georgia, Times, 'Times New Roman', serif;">ABOUT US</h2>
