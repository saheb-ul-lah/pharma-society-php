...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!in_array($role, ['student', 'alumni'])) {
        ...
        $checkEmailStmt = $conn->prepare("SELECT user_email FROM `signup-users` WHERE user_email = ?");
        ...
        if ($checkEmailStmt->num_rows > 0) {
            ...
            $stmt = $conn->prepare("INSERT INTO `signup-users` (user_name, user_email, user_password, role) VALUES (?, ?, ?, ?)");
...
<body class="bg-light">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <form method="post" class="form-control mt-5 p-4"
            ...
            <div class="mb-2 mt-2">
                <label for="role"><i class="fa fa-id-card"></i> Role</label>
            ...
            <div class="mb-2 mt-4">
                <p class="text-center" style="font-weight: 600; color: navy;">I have an Account <a href="./login.php"
