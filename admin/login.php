...
// Capture the `redirect` parameter if present
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("SELECT user_password FROM `signup-admins` WHERE user_email = ?");
...
<body class="bg-light">
    <div class="container p-5 d-flex flex-column align-items-center">
        ...
        <?php endif; ?>
        <form action="login.php<?php echo isset($_GET['redirect']) ? '?redirect=' . urlencode($_GET['redirect']) : ''; ?>" method="POST" class="form-control mt-5 p-4"
