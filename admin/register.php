...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $checkEmailStmt = $conn->prepare("SELECT user_email FROM `signup-admins` WHERE user_email = ?");
    ...
    if ($checkEmailStmt->num_rows > 0) {
        ...
        // Prepare and bind
        $stmt = $conn->prepare("INSERT INTO `signup-admins` (user_name, user_email, user_password) VALUES (?, ?, ?)");
